...
export class MapComponent implements OnInit {
  ...
  constructor(
    ...
    private leyerService: LeyerService
  ) {}
 ...
 //   this.map.addControl(zoomToExtent);
    ...
    this.authService.subsystemChanged.subscribe(rec => {
      this.leyerService
        .getSubSystemLayers(this.authService.getCurrentSubsystemObject().id)
        .subscribe(rec => {
          ...
          this.layerList.forEach(value => {
            ...
            // this.map.addLayer(
            //   // new Tile({
            //   //   title: "<img width='24px' src='" + value.symbol + "'/> "+"&nbsp" + value.title,
            //   //   visible: value.visible,
            //   //   source: new TileWMS({
            //   //     url: environment.gisServer,
            //   //     params: {
            //   //       LAYERS: value.url
            //   //     }
            //   //   })
